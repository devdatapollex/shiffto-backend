...
router.get("/traveler-summary", authGuard(), PaymentController.getTravelerSummary);

// Admin Payment Release
router.post("/:transactionId/release", authGuard({ adminOnly: true }), PaymentController.releasePayment);
