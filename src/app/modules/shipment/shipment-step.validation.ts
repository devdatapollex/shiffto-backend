...
const confirmPickupSchema = z.object({
  photoUrl: z
    ...
    .transform((val) => val || "https://placehold.co/600x400?text=Pickup+Proof+Placeholder"),
...
const confirmDeliverySchema = z.object({
  photoUrl: z
    ...
    .transform((val) => val || "https://placehold.co/600x400?text=Delivery+Proof+Placeholder"),
  notes: z.string().optional(),
});
