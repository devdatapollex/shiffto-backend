...
const approveWithdrawal = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await WithdrawalService.approveWithdrawal(id, payoutTxnId, user);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
...
const rejectWithdrawal = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await WithdrawalService.rejectWithdrawal(id, rejectionReason, user);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
